// Elegant line-art SVG icons (Lucide-inspired)
const s = (d: string, size = 16) =>
...
export const ICONS = {
  ...
  pizza: s('<path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2z"/><path d="M12 8v8"/><path d="M8.5 10.5l7 1"/><path d="M8.5 13.5l7-1"/>'),
};
